...
if __name__ == "__main__":
    ...
    oxford_output_dir = 'scan_not_irregular_oxford_verb_analysis_output'
    riverside_output_dir = 'scan_not_irregular_riverside_verb_analysis_output'
    combined_output_dir = 'scan_not_irregular_combined_verb_analysis_output'
