...
if __name__ == "__main__":
    ...
    oxford_output_dir = 'scan_oxford_verb_analysis_output'
    riverside_output_dir = 'scan_riverside_verb_analysis_output'
    combined_output_dir = 'scan_combined_verb_analysis_output'
